---
title: "AI-HED Follow-Up Workshop Brings Together European Educators to Reflect on AI in Higher Education"
subtitle: "Key findings from the Pilot Semester and a roadmap for what comes next"
summary: "On March 18, 2026, the AI-HED Pilot Semester Follow-Up Workshop brought together lecturers from across partner institutions to share findings, best practices, and reflections on 24 AI-enhanced courses involving more than 1,100 students."
description: "A report on the AI-HED Pilot Semester Follow-Up Workshop held on 18 March 2026, covering key findings on AI use in higher education, pedagogical insights, and the next steps for the Erasmus+ project."
...
categories:
  - Updates
slug: pilot-follow-up-workshop
url: /post/pilot-follow-up-workshop/
aliases:
  - /post/260318-pilot-follow-up-workshop/

resources:
  - src: images/croatia/2af8da12-09bb-47e4-99f5-a7b71e059588.jpg
    name: header
...
<div class="row text-center my-5">
  <div class="col-md-4 col-6 mb-4">
    ...
    <p class="text-muted mb-0">AI-Enhanced Courses</p>
  </div>
  <div class="col-md-4 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">1,100+</div>
    <p class="text-muted mb-0">Students</p>
  </div>
  <div class="col-md-4 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">70%</div>
    <p class="text-muted mb-0">Teachers Recommend AI Integration</p>
  </div>
</div>
