---
title: "AI-HED: One Year In – Building Confidence and Clarity Around AI in Higher Education"
subtitle: "From Experimentation to Evidence"
summary: Just over a year into the Erasmus+ project AI-HED, we are proud to share concrete results, meaningful insights, and a growing community of engaged educators across Europe working to support lecturers and students in navigating AI in education.
description: "A progress report on the AI-HED project after one year: achievements, pilot courses, training sessions, and early evidence showing how AI is transforming higher education teaching and learning across Europe."
...
resources:
  - src: images/20250509_120532.jpg
    name: "header"
layout: single 
...
<div class="row text-center my-5">
  <div class="col-md-3 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">4</div>
    <p class="text-muted mb-0">Countries</p>
  </div>
  <div class="col-md-3 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">40</div>
    <p class="text-muted mb-0">Teachers Trained</p>
  </div>
  <div class="col-md-3 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">24</div>
    <p class="text-muted mb-0">Pilot Courses</p>
  </div>
  <div class="col-md-3 col-6 mb-4">
    <div class="display-4 font-weight-bold text-primary">1</div>
    <p class="text-muted mb-0">Year of Progress</p>
  </div>
</div>
...
<div class="card bg-light border-0 my-5">
  <div class="card-body p-4">
    ...
    <h4>AI as a Thinking Partner, Not a Shortcut</h4>
    <p>In the <em>Consumer Branding</em> course, students created generative AI personas based on real consumer research. These personas became interactive testing tools for brand concepts and campaign ideas—forcing students to confront their assumptions and refine their thinking iteratively.</p>
    <p class="mb-0 text-muted">For students like Stijn, AI functioned as a didactical tool that strengthened critical thinking and evidence-based decision-making.</p>
  </div>
</div>
...
Curious to learn more about upcoming results, new tools, and future events?

Register for the AI-HED newsletter to stay informed and involved as the project continues.